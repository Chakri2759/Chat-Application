...
export const SettingsPage = () => {
  ...
  return (
    <div className="min-h-screen container mx-auto px-4 pt-20 pb-10">
      <div className="flex flex-col items-center space-y-6">
        ...
        <div className="flex justify-center gap-4 w-full max-w-md ">
          {THEMES.map((t) => (
            <button
              key={t}
              className={`
                group flex flex-col items-center gap-1.5 p-4 rounded-lg transition-colors w-full
        ...
        <div className="rounded-xl border border-base-300 overflow-hidden bg-base-100 shadow-lg w-full max-w-2xl">
